...
<?php endif ?>
   ...
   <div id="detail_or_dc" class="main-content" style="background-color: #8A2BF9;">
      <div class="container">
         <div class="baris">
            <div class="col mt-2">
               <div class="card-md">
                  ...
                  <div class="card-body">
                     <form action="" method="post">
                        ...
                        <div class="jdl-or" style="background-color: #8A2BF9;">
                           <h4>Customer</h4>
                        </div>
                        ...
                        <div class="form-footer_detail">
                           <div class="buttons">
                              <button type="submit" name="bayar_dc" class="btn-sm bg-primary" style="background-color: #8A2BF9;">Bayar Sekarang</button>
                           </div>
                        </div>
                     </form>
                  </div>
