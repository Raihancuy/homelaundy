...
<?php endif ?>
   ...
   <div id="detail_or_cs" class="main-content" style="background-color: #8A2BF9;">
      <div class="container">
         <div class="baris">
            <div class="col mt-2">
               <div class="card-md">
                  ...
                  <div class="card-body">
                     <form action="" method="post">
                        ...
                        <div class="form-footer_detail">
                           <div class="buttons">
                              <button type="submit" name="bayar_cs" class="btn-sm bg-primary" style="background-color: #8A2BF9;">Bayar Sekarang</button>
                           </div>
                        </div>
                     </form>
                  </div>
